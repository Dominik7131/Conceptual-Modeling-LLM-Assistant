...
%The common thing is that approaches with CoT achieve high recall but low recall which is than translated into low $F_1$ score + vysvětlení, že jediný generuje jako první original text.
