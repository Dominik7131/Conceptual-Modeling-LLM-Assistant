...
In this thesis, we presented an approach to designing conceptual modeling assistants based on pre-trained Large Language Models (LLMs) that help human modeling experts mainly discover classes, their attributes, and binary associations in the given textual domain description.
...
On the other hand, we did not focus on more complex ontological constructs such as the most recent \cite{eswc2024ontologyllm}.
