...
const Topbar: React.FC<props> = ({handleIgnoreDomainDescriptionChange, onImportButtonClick, onPlusButtonClick, onSummaryButtonClick, summaryData, capitalizeString,
    domainDescription, nodeToAddName, setNodeToAddName, OnClickAddNodeUser, setDomainDescription, inferenceIndexes}) =>
{
    ...
    // const handleNodeNameChange = (event : React.ChangeEvent<HTMLButtonElement, ChangeEvent>) =>
    ...
    return (
        <div className="topBar">
            ...
            <div className="container">
                ...
                <div className="buttonsContainer">
                    <button className="addNodeButton" onClick={(event) => OnClickAddNodeUser(event)}>Add node </button>
                    <input
                        name="nodeName"
