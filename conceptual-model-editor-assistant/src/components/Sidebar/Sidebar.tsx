...
import { isLoadingSuggestedItemsState, isSidebarOpenState, sidebarTabValueState, sidebarWidthPercentageState, suggestedAttributesState, suggestedEntitiesState, suggestedRelationshipsState } from '../../atoms';
    ...
    return (
        <Drawer
            ...
            <TabContext value={tabValue}>
                ...
                <TabPanel value="0">
                    <Suggestions items={entities} isLoading={isLoading} title={""}/>
                </TabPanel>

                <TabPanel value="1">
                    <Suggestions items={attributes} isLoading={isLoading} title={attributeSourceEntity}/>
                </TabPanel>

                <TabPanel value="2">
                    <Suggestions items={relationships} isLoading={isLoading} title={relationshipsSourceEntity}/>
                </TabPanel>
            </TabContext>
