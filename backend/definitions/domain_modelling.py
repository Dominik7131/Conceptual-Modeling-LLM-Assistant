...
DOMAIN_MODELING_DIRECTORY_PATH = os.path.join(
    DOMAIN_MODELING_BENCHMARK_DIRECTORY, "evaluation domain models")
...
DOMAIN_PROMPTING_DIRECTORY_PATH = os.path.join(
    DOMAIN_MODELING_BENCHMARK_DIRECTORY, "prompting domain models")
