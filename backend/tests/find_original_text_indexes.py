...
def check_tests(tests):
    ...
    for test in tests:
        ...
        actual_original_text_indexes, _, _ = OriginalTextFinder.find_in_domain_description(
            original_text, domain_description, user_choice=UserChoice.ATTRIBUTES.value)
