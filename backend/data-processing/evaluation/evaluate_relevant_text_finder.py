...
def process_test_cases(test_cases, text_index, filtering_variation, text_finder, domain_description, domain_description_path, is_print_failed_tests):
    ...
    for test_case in test_cases:
        ...
        actual_relevant_texts = get_actual_relevant_texts(
        ...
        process_test_casses_attributes(test_case, actual_relevant_texts, expected_relevant_texts,
...
def run_test(filtering_variation, is_print_failed_tests):
    ...
    for index, domain_model in enumerate(DOMAIN_MODELS):
        for i in range(DOMAIN_DESCRIPTIONS_COUNT[index]):
            ...
            with open(domain_description_path, encoding="utf-8") as file:
                domain_description = file.read()

            process_test_cases(test_cases, text_index, filtering_variation, text_finder,
                               domain_description, domain_description_path, is_print_failed_tests)
